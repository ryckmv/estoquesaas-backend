...
export class DashboardService {
  ...
  async resumo(empresaId: string | bigint) {
...
return {
  ...
  private async buscarResumo(empresaId: bigint) {
  ...
  private async buscarFinanceiro(empresaId: bigint) {
    ...
    return {
      ...
      faturamentoHoje:
        Number(faturamentoHoje._sum.valorTotal ?? 0),

      faturamentoMes:
        Number(faturamentoMes._sum.valorTotal ?? 0)
...
private async buscarEstoque(empresaId: bigint) {
 ...
 return {
  ...
  private async buscarUltimasVendas(empresaId: bigint) {
    ...
    return vendas.map(venda => ({
      ...
      usuario:
        venda.usuario?.nome ?? 'Não informado',
    ...
    private async buscarGraficoVendas(empresaId: bigint) {
...
select: {
  ...
  return dias;
    ...
    private async buscarProdutosMaisVendidos(empresaId: bigint) {
  ...
  async resumoMaster() {
    ...
    return {
      ...
      financeiro: {
        faturamentoTotal:
          Number(faturamento._sum.valorTotal ?? 0)
      }
    };
